package com.clone.instagram.graphservice.service;

import com.clone.instagram.graphservice.domain.Friendship;
import com.clone.instagram.graphservice.domain.NodeDegree;
import com.clone.instagram.graphservice.domain.User;
import com.clone.instagram.graphservice.repository.UserRepository;
import com.clone.instagram.graphservice.web.rest.error.UsernameAlreadyExistsException;
import com.clone.instagram.graphservice.web.rest.error.UsernameNotExistsException;
import com.clone.instagram.graphservice.web.rest.vm.PagedResult;
...
//                        .startNode(savedFollower)
    ...
    public boolean unfollow(String userA, String userb) {
        userRepository.unfollow(userA, userb);
        return true;
    }
