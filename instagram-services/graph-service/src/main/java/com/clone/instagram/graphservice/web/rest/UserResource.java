package com.clone.instagram.graphservice.web.rest;


import com.clone.instagram.graphservice.domain.User;
import com.clone.instagram.graphservice.service.UserService;
import com.clone.instagram.graphservice.util.AppConstants;
import com.clone.instagram.graphservice.web.rest.vm.ApiResponse;
import com.clone.instagram.graphservice.web.rest.vm.FollowRequest;
...
public class UserResource {
    ...
    @PostMapping("/users/{usernameA}/unfollow/{usernameB}")
    public ResponseEntity<?> unfollow(@PathVariable String usernameA, @PathVariable String usernameB) {
        log.info("received request unfollow user {} by follwer {}"
                , usernameB, usernameA);

        return ResponseEntity.ok(userService.unfollow(usernameA, usernameB));
    }
